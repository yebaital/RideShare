...
public class CustomerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn = findViewById(R.id.customer_register_button);
        loginBtn = findViewById(R.id.customer_login_button);
        label = findViewById(R.id.customer_label);
        registerPrompt = findViewById(R.id.customer_register_prompt);
        loginPrompt = findViewById(R.id.customer_login_prompt);
        emailText = findViewById(R.id.customer_email);
        passwordText = findViewById(R.id.customer_password);
        progressBar = findViewById(R.id.customer_progress);

        registerPrompt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                label.setText(getString(R.string.customer_registration));
        ...
        loginPrompt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                label.setText(getString(R.string.customer_login));
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                customerRef = db.getReference().child("users").child("customers").child(userId);
    ...
    private void goHome() {
        startActivity(new Intent(CustomerLoginActivity.this, CustomersMapActivity.class));
    }
